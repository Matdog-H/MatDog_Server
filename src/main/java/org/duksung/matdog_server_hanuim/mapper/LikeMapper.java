...
//    int update_like(@Param("userIdx") final int userIdx, @Param("registerIdx") final int registerIdx, @Param("likereq") final LikeReq likeReq);
    ...
    @Select("SELECT likeStatus FROM register_like_lost WHERE register_like.userIdx = #{userIdx} AND registerIdx=#{registerIdx} AND registerStatus=#{registerStatus}")
    ...
    @Select("SELECT likeStatus FROM register_like_spot WHERE register_like.userIdx = #{userIdx} AND registerIdx=#{registerIdx} AND registerStatus=#{registerStatus}")
