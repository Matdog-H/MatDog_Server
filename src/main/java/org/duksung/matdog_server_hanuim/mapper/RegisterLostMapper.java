...
public interface RegisterLostMapper {
    ...
    //실종 공고 등록
    @Insert("INSERT INTO register_lost(userIdx, status, variety, gender, weight, age, protectPlace, lostPlace,lostDate, feature, tel, email, dm) " +
            ...
            "#{register_lost.email}, #{register_lost.dm})")
